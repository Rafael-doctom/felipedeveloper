    ...
    <div class="content">
      <div class="cards">
        <div class="card">
          ...
          <p>
            Cronômetro desenvovido em atividade Academica, ultilizando linguagens como 
          </p>
          <p>HTML - CSS - JS </p>
        </div>
        <div class="card">
          <h3>Sistema de Cadastro - CRUD</h3>
          <div class="img-wrapper">
            <img
              src="/sistemadelista.png"
          ...
          <p>
            Aplicação desenvolvida para gestão de Lojas, nela foram ultilizadas as linguagens
          </p>
          <p>HTML - CSS - JS</p>
        </div>
